!(function (a) {
    ...
    function (a, o, i) {
        ...
        function l(a) {
            const o = a.href;
            return !c((i = o)) || i.startsWith(r) ? o : r + o;
            var i;
        }
        const k = n.f(),
            g = n.g(),
        ...
        function b(a) {
            const o = a.href;
            return o.startsWith(r) ? o.substr(u) : o;
        }
        function f(a, o) {
            let i;
            if (g) i = h;
        ...
        function z(a, o) {
            return a.replace(/(;\s*url=)(.+)/i, (a, i, e) => i + d(e, o));
        }
        const x = {
            ...
            const n = a.substr(m).replace(/^-*/, ""),
                t =
                    (function (a) {
                        if (!q) {
                            q = new Map();
                            for (const [a, o] of Object.entries(x)) for (const i of o) q.set(i, a);
                        }
                        const o = q.get(a);
                        if (o) return "https://" + o + "/";
                    })(n) ||
    ...
    function (a, o, i) {
        ...
        const { getOwnPropertyDescriptor: e, defineProperty: n, apply: t } = Reflect,
            s = {};
        function r(a, o, i) {
            const e = a[o];
            if (!e) return !1;
        ...
        function u(a, o, i, t) {
            const s = e(a, o);
            return !!s && (i && r(s, "get", i), t && r(s, "set", t), n(a, o, s), !0);
        }
        function m(a) {
            function o(a, o, i, e) {
                u(
                    ...
                    e.forEach((e) => {
                        ...
                        !n &&
                            ...
                            r(
                                ...
                                (a) =>
                                    function (o) {
                                        return console.warn("setAttributeNode:", o, this), t(a, this, arguments);
                                    }
                            ));
                },
                addNode: function (a) {
    ...
    function (a, o, i) {
        ...
        function l(a) {
            let o = 0;
            for (let i = 0, e = a.length; i < e; i++) o = (31 * o + a.charCodeAt(i)) >>> 0;
            return o;
        }
        function k(a, o) {
            return ("00000000" + a.toString(16)).slice(-o);
        }
        function g() {
    ...
    function (a, o, i) {
        ...
        let e = new Set();
        function n() {
            (this.id = ""), (this.name = ""), (this.value = ""), (this.domain = ""), (this.hostOnly = !1), (this.path = ""), (this.expires = NaN), (this.isExpired = !1), (this.secure = !1), (this.httpOnly = !1), (this.sameSite = "");
        }
        function t(a, o) {
        ...
        class r {
            ...
            nextChild(a) {
                return this.children[a] || (this.children[a] = new r());
            }
            getChild(a) {
        ...
        function c() {
            const a = [];
            for (const o of u.values()) o.httpOnly || a.push(o);
            return a;
        }
        function p(a, o, i) {
            const e = new n(),
            ...
            for (let a = 0; a < r.length; a++) {
                ...
                const t = r[a].trim(),
                    s = t.indexOf("=");
                if ((-1 !== s ? ((o = t.substr(0, s)), (n = t.substr(s + 1))) : ((o = 0 === a ? "" : t), (n = 0 === a ? t : "")), 0 !== a))
            ...
            const u = o.hostname;
            if (e.domain) {
                if (((m = e.domain), (c = u) !== m && !c.endsWith("." + m))) return void console.warn("[jsproxy] invalid cookie domain! `%s` ⊄ `%s`", e.domain, u);
            } else (e.domain = u), (e.hostOnly = !0);
            var m, c;
            const p = o.pathname;
            if (e.path) {
                if (!t(e.path, p)) return void console.warn("[jsproxy] invalid cookie path! `%s` ⊄ `%s`", e.path, p);
            } else e.path = p;
        ...
        function l(a) {
            ...
            if (i)
                a.isExpired
                    ? (u.delete(o), (i.isExpired = !0))
                    : ((t = a),
                      ((n = i).id = t.id),
                      (n.name = t.name),
                      (n.value = t.value),
                      (n.domain = t.domain),
                      (n.hostOnly = t.hostOnly),
                      (n.path = t.path),
                      (n.expires = t.expires),
                      (n.isExpired = t.isExpired),
                      (n.secure = t.secure),
                      (n.httpOnly = t.httpOnly),
    ...
    function (a, o, i) {
        ...
        function r(a, o) {
            let i = 0;
            for (const { weight: e, host: n } of s[o]) if ((i += e) > a) return n;
        }
        function u(a, o) {
            return `${o}${
                (function (a) {
                    return /^(localhost|127\.\d+\.\d+\.\d+)([:\/]|$)/.test(a);
                })(a)
                    ? ""
                    : "s"
            }://${a}/${o}`;
        ...
        function m(a, o) {
            let i = t.node_default;
            return 2 === o && (i = t.node_acc), r(a, i);
        }
        function c(a, o) {
            let i = "https";
            switch (a.protocol) {
        ...
        function p(a) {
            ...
            for (const [o, i] of Object.entries(a.node_map)) {
                const a = [];
                let e = 0;
                for (const [o, n] of Object.entries(i.lines))
                    (e += n),
                        a.push({
                            host: o,
                            weight: n,
    ...
    function (a, o, i) {
        ...
        class e {
            constructor() {
                this._promise = new Promise((a, o) => {
                    (this._resolve = a), (this._reject = o);
                });
            }
            wait() {
    ...
    function (a, o, i) {
        ...
        function n(a) {
            let o = !1;
            return (a = (a = a.replace(/(\b)location(\b)/g, (a, i, e) => ((o = !0), i + "__location" + e))).replace(/postMessage\s*\(/g, (a) => ((o = !0), a + "...(self.__set_srcWin?__set_srcWin():[]), "))), o ? a : null;
        }
        function t(a, o) {
            const i = e.a(a, o),
                t = n(i);
    ...
    function (a, o, i) {
        ...
        class n {
            constructor(a) {
                (this._name = a), (this._db = null);
            }
            _getStore(a, o) {
                return this._db.transaction(a, o).objectStore(a);
            }
            open(a) {
                const o = new e.a(),
                ...
                return (
                    (i.onsuccess = (e) => {
                        ...
                        (this._db = n),
                            (n.onclose = (o) => {
                                console.warn("[jsproxy] indexedDB disconnected, reopen..."), this.open(a);
                            }),
                            o.notify();
                    }),
                    (i.onerror = (a) => {
                        console.warn("req.onerror:", a), o.abort(i.error);
                    }),
                    (i.onupgradeneeded = (o) => {
                        const e = i.result;
                        for (const [o, i] of Object.entries(a)) e.createObjectStore(o, i);
                    }),
                    o.wait()
                );
            }
    ...
    function (a, o, i) {
        ...
        const { apply: c, defineProperty: p, ownKeys: l, getOwnPropertyDescriptor: k } = Reflect,
            g = void 0;
        function h(a, o, i) {
            const e = a[o];
            if (!e) return;
            ...
            function m() {
                ...
                for (let e = 0; e < o.length; e++) {
                    const t = o[e];
                    "string" == typeof t && t.startsWith(i) && a.push(t.substr(n));
                }
                return a;
            }
            const c = new Proxy(e, {
                ...
                getOwnPropertyDescriptor(a, o) {
                    if ("string" == typeof o) return k(e, i + o);
                },
            });
            p(a, o, {
                value: c,
        ...
        function b(a, o) {
            !(function (a, o) {
                ...
                function m(a) {
                    return function (o) {
                        return arguments.length > 0 && (arguments[0] = i + o), c(a, this, arguments);
                    };
                }
                s.d(u, "key", r),
                    s.d(
                ...
                s.c(k, "open", m),
                    ...
                    s.c(k, "delete", m),
                    s.c(a, "openDatabase", m);
            })(a, o);
            !(function (a) {
                const o = a.location;
                let i;
                function n(a) {
                    return new URL(e.b(a));
                }
                const t = {
                        get href() {
                            return n(o).href;
                        ...
                        set href(a) {
                            console.log("[jsproxy] set location.href:", a), (o.href = e.i(a, this));
                        },
                        set protocol(a) {
                        ...
                        reload() {
                            return console.warn("[jsproxy] location.reload"), o.reload(...arguments);
                        },
                        replace(a) {
                            return a && (console.warn("[jsproxy] location.replace:", a), (arguments[0] = e.i(a, this))), o.replace(...arguments);
                        },
                        assign(a) {
                            return a && (console.warn("[jsproxy] location.assign:", a), (arguments[0] = e.i(a, this))), o.assign(...arguments);
                        },
                    },
            ...
            function p(o) {
                s.c(
                    ...
                    (a) =>
                        function (i) {
                            return i && (console.log("[jsproxy] new %s: %s", o, i), (arguments[0] = e.i(i, this))), j(a, arguments);
                        }
                );
            }
            s.c(
                ...
                (a) =>
                    function (o, i) {
                        return i && (arguments[1] = e.i(i, this)), d(a, this, arguments);
                    }
            ),
                s.d(
                    r,
                ...
                s.c(
                    ...
                    (a) =>
                        function (...o) {
                            const i = o.map(e.i);
                            return console.log("[jsproxy] importScripts:", i), d(a, this, i);
                        }
                );
        }
    },
    ...
    function (a, o, i) {
        ...
        function k(a, o) {
            ...
            new a.MutationObserver(function (a) {
                a.forEach((a) => {
                    a.addedNodes.forEach(s), a.removedNodes.forEach(r);
                });
            }).observe(i, {
                childList: !0,
                subtree: !0,
        ...
        function g(a) {
            ...
            const { location: h, navigator: d } = a,
                j = new URL(o.baseURI),
                b = r.b(a);
            c.d(a, {
                loc: h,
            ...
            !(function () {
                ...
                f.startMessages && f.startMessages();
            ...
            z &&
                ...
                r.c(
                    ...
                    (a) =>
                        function (o) {
                            return o && (arguments[0] = s.i(o, o)), l(a, this, arguments);
                        }
                );
            const _ = a.frames;
            (a.frames = new Proxy(_, {
                get(a, o) {
                    if ("number" == typeof o) {
                ...
                r.c(
                    ...
                    (a) =>
                        function (o, i, e) {
                            return console.log("registerProtocolHandler:", arguments), l(a, this, arguments);
                        }
                );
            ...
            r.d(
                ...
                (a) =>
                    function (o) {
                        console.log("[jsproxy] set document.domain:", o), (E = o), a.call(this, h.hostname);
                    }
            ),
                r.d(
                    q,
                    ...
                    (a) =>
                        function () {
                            const { ori: a } = c.e(this);
                            return u.c(a);
                        },
                    (a) =>
                        function (a) {
                            const { ori: o } = c.e(this),
                                i = u.b(a, o, Date.now());
                            i && (u.d(i), w(e.c, i));
                        }
                ),
                ...
                r.c(
                    ...
                    (a) =>
                        function (o, i) {
                            ...
                            return i && "*" !== i && (arguments[1] = "*"), l(a, e, arguments);
                        }
                );
            ...
            function M(a, o, i) {
                b.attr(a, o, {
                    name: i,
                    onget(a) {
                        return null === a ? "" : s.d(a, this);
                    },
                    onset(a) {
                        return "" === a ? a : s.i(a, this);
                    },
                });
            }
            b.attr(
            ...
            b.attr("BASE", U, {
                ...
                r.c(
                    ...
                    (a) =>
                        function () {
                            return (this.action = this.action), l(a, this, arguments);
                        }
                );
            ...
            b.attr(
                ...
                A,
                {
                    ...
                    onset(a) {
                        return t.f(a) || (a = "utf-8"), C.set(this, a), a;
                    },
                },
                {
                    name: "integrity",
            ...
            function F(a, o) {
                const i = a.type;
                return i && !t.e(i) ? null : B.has(a) ? null : (B.add(a), m.b(o));
            }
            function J(a) {
                const i = new WeakSet();
                o.addEventListener(
    ...
    function (a, o, i) {
        ...
        function q(a) {
            return v.get("url-cache", a);
        }
        async function E(a, o, i, e) {
            await v.put("url-cache", {
                url: a,
                host: o,
                info: i,
                expires: e,
                    ...
                    "user-agent" !== o &&
                        (!(function (a, o) {
                            return "content-type" === a
                                ? "application/x-www-form-urlencoded" === o || "multipart/form-data" === o || "text/plain" === o
                                : "accept" === a || "accept-language" === a || "content-language" === a
                                ? o.length < 256 && !S.test(o)
                                : void 0;
                        })(o, a)
                            ? (n[o] = a)
                            : e.set(o, a));
                }),
                n.origin && (n.origin = i.origin);
            const s = a.referrer;
            return (
                s && (n.referer = s === y ? i.origin + "/" : t.c(s)),
                (n.cookie = (function (a, o, i) {
                    const e = i.credentials;
                    if ("omit" === e) return "";
                    if ("same-origin" === e && u.a(a.hostname) !== u.a(o.hostname)) return "";
                    return r.c(a);
                })(o, i, a)),
                {
                    reqHdr: e,
        ...
        function L(a, o) {
            a.referrer = "/?" + new URLSearchParams(o);
        }
        const O = 5;
        async function M(a, o, i) {
            ...
            if ((a.signal && (m.signal = a.signal), !t.j(o.protocol))) {
                return {
                    res: await fetch(a),
                };
            }
            ...
            for (let a = 0; a < O; a++) {
                ...
                try {
                    (f["--level"] = z), L(m, f), (y = await fetch(e, m));
                } catch (a) {
                    console.warn("fetch fail:", e);
                    break;
                }
                if (((v = y.headers), x && v.has("--t") && ((x = !1), delete f["--aceh"]), v.has("--switched"))) {
                    (k = v.get("--raw-info")), z++;
                    continue;
                }
                const s = v.get("--error");
            ...
            if ("GET" === e && 200 === _) {
                const a = (function (a) {
                    const o = a.get("cache-control");
                    if (o) {
                        if (/no-cache/i.test(o)) return -1;
                        const a = o.match(/(?:^|,\s*)max-age=["]?(\d+)/i);
                        if (a) {
                            const o = +a[1];
                            if (o > 0) return o;
                        }
                    }
                    const i = a.get("expires");
                    if (i) {
                        const a = Date.parse(i);
                        if (a > 0) return ((a - Date.now()) / 1e3) | 0;
                    }
                    return 0;
                })(S);
                if (a >= 0) {
            ...
            if (M.length) {
                const a = (function (a, o, i) {
                    if (!w) {
                        const a = u.a(o.hostname);
                        if (u.a(i.hostname) !== a) return;
                    }
                    const e = [],
                        n = Date.now();
                    for (const i of a) {
        ...
        async function Q(a, o, i) {
            const e = await B.matchAll({
                type: "window",
            });
            for (const n of e) "top-level" === n.frameType && ((i && n.id === i) || J(n, a, o));
        }
        const Z = new Map();
        async function aa(a, o, i, e) {
            ...
            m || ((m = r.headers), (p = !1));
            const l = (a, o) => {
                    p || ((m = new Headers(m)), (p = !0)), m.set(a, o);
                },
                k = m.get("gateway-err--");
            if (k)
                        ...
                        case 204:
                            switch (n) {
                                case "ORIGIN_NOT_ALLOWED":
                                    e = "The current domain name is not in the whitelist of the server outside the chain";
                                    break;
                                case "CIRCULAR_DEPENDENCY":
                                    e = "Circular proxy for current request";
                                    break;
                                case "SITE_MOVE":
                                    e = `Move the current site to: <a href="${s}">${s}</a>`;
                            }
                            break;
                        case 500:
                            e = "Proxy server internal error";
                            break;
                        case 502:
                            e = t ? `The proxy server cannot connect to the website ${i.origin} (${t})` : `The proxy server cannot resolve the domain name ${i.host}`;
                            break;
                        case 504:
                            (e = `Proxy server connection to the website timed out ${i.origin}`), t && (e += ` (${t})`);
                    }
                    return X(e);
                })(k, u, o);
            const g = {
            ...
            if (301 === u || 302 === u || 303 === u || 307 === u || 308 === u) {
                const n = m.get("location"),
                    s = n && t.k(n, o);
                if (s) {
                    if ("follow" === a.redirect) return ++e === H ? X("Too many redirects", 500) : aa(a, s, i, e);
                    l("location", t.g(s));
                }
        ...
        async function oa(a, o) {
            ...
            const n = new URL(e);
            try {
                return await aa(a.request, o, n, 0);
            } catch (a) {
                return console.error(a), X("Front-end script error<br><pre>" + a.stack + "</pre>", 500);
            }
        }
        let ia, ea;
        async function na() {
        ...
        function ta(a, o) {
            ...
            !(function (a) {
                ...
                (F = (function (a) {
                    const o = {};
                    if (!a) return o;
                    for (const [i, e] of Object.entries(a)) o[i] = e;
                    return o;
                })(a.url_handler)),
                (async function (a) {
        ...
        C.addEventListener("fetch", (a) => {
            a.respondWith(
                (async function (a) {
                    ...
                    const o = a.request,
                        i = t.e(o.url);
                    if (i === e.g || i === e.d) {
                        let a = I.assets_cdn + I.index_path;
                        return I.index_path || (a = I.assets_cdn + "index_v3.html"), X((await fetch(a)).body);
                    }
                    if (i === e.b || i === e.e) return fetch(i);
                    if (i === e.c) return fetch(self.__FILE__);
                    if (i.startsWith(e.a)) {
                        const a = i.substr(e.a.length);
                        return fetch(I.assets_cdn + a);
                    }
                    if ("navigate" === o.mode) {
                        const a = t.a(i);
                        if (a) return Response.redirect(a, 301);
                    }
                    let n = t.c(i);
                    const s = F[n];
                    if (s) {
            ...
            C.addEventListener("install", (a) => {
                console.log("oninstall:", a), a.waitUntil(C.skipWaiting());
            }),
            C.addEventListener("activate", (a) => {
                console.log("onactivate:", a), Q(P.m, 1), a.waitUntil(B.claim());
            }),
